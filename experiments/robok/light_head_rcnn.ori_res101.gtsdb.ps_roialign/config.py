...
class Config:
    ...
    from datasets_odgt.gtsdb import GTSDB as datadb

    # Not sure what to do with these constants
    ...
    train_root_folder = os.path.join(root_dir, 'data/gtsdb')
    train_source = os.path.join(
        root_dir, 'data', 'gtsdb/odformat/gtsdb_train.odgt')

    eval_root_folder = os.path.join(root_dir, 'data/gtsdb')
    eval_source = os.path.join(
        root_dir, 'data', 'gtsdb/odformat/gtsdb_val.odgt')
